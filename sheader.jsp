...
<body>
<div id="topPan">
<br><br><br><h1>Southern Power Distribution Company</h1>
...
<div id="headerPan">
  ...
  <div id="headermiddlePan">
  	<div id="menuPan">
		<ul>
			<li class=
			"home" ><a href="spdc_home.jsp">Home</a></li>
			<li class=
			"home" ><a href="spdc_bill.jsp">Generate Bill</a></li>
			<li class=
			"home" ><a href="spdc_v_bill.jsp">View Bills</a></li>
	...
	<div id="headerbodyPan">
	  <div id="headerleftredPan">
              <h2> Southern Power Distribution Supply<br />
</h2>
