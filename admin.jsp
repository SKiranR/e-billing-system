...
<%@ include file="header.jsp"%>
 ...
 <form name="s" action="login2.jsp" method="get" onsubmit="return valid()">
              ...
              <tr> 
                <td colspan="2" align="center"><font size="2"><b> 
                  <%
                                                       ...
                                                       {
                                                               out.println("<a href=admin.jsp><img src=images/mess_error.gif ></a>&nbsp;&nbsp;<font color='red'><blink>Your username and password is incorrect !</blink></font>");
                                                       }
                                               %>
                  </b></font></td>
              </tr>
