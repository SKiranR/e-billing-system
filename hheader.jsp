...
<body>
<div id="topPan">
<br><br><br><h1>Hyderabad Metropolitan Water Supply</h1>
...
<div id="headerPan">
  ...
  <div id="headermiddlePan">
  	<div id="menuPan">
		<ul>
			<li class=
			"home" ><a href="hmws_home.jsp">Home</a></li>
			<li class=
			"home" ><a href="hmws_bill.jsp">Generate Bill</a></li>
			<li class=
			"home" ><a href="hmws_v_bill.jsp">View Bills</a></li>
			
			<li class=
			"home" ><a href="index.jsp">Logout</a></li>
	...
	<div id="headerbodyPan">
	  <div id="headerleftredPan">
	  	<h2> Hyderabad Metropolitan Water Supply<br />
</h2>
<p><span class="largetext">...............</p>
	  </div>
