...
<body>
<div id="topPan">
<br><br><br><h1>E-Billing System</h1>
...
<div id="headerPan">
  ...
  <div id="headermiddlePan">
  	<div id="menuPan">
		<ul>
			<li class="home" ><a href="admin_home.jsp">Home</a></li>
			
			<li><a href="new.jsp">New Members</a></li>
			<li><a href="mem.jsp">Members</a></li>
