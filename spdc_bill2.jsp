...
String sql="ALTER TABLE spdc_bill_g ADD "+column+" VARCHAR(20) ";
st.executeUpdate(sql);
Statement st2 = con.createStatement();
String sql2="ALTER TABLE spdc_bill_p ADD "+column+" VARCHAR(20) ";
...
%>
<form method="post" action="spdc_bill3.jsp">
